...
unified_data_dir = "/data/obs/campaigns/eurec4a/HALO/unified/v0.9/"
WALES_data_dir = "/data/obs/campaigns/eurec4a/HALO/20200205/WALES-LIDAR/"
retrieval_data_dir = "/home/mjacob/data/EUREC4A/LWPIWV_CERA/v0.4.0.4_2021-02-25/"
path_plots = "/net/blanc/awalbroe/Plots/EUREC4A/HAMP_cloudmask/quicklooks/"
path_cloudmasks = "/net/blanc/awalbroe/Data/EUREC4A/HAMP_cloud_mask/"
...
date = '20200205'
cloud_mask_version = '0.9.1'

radar_cm = xarray.open_dataset(f'{path_cloudmasks}EUREC4A_HALO_HAMP-Radar_cloud_mask_{date}_v{cloud_mask_version}.nc')
radiometer_cm = xarray.open_dataset(f'{path_cloudmasks}EUREC4A_HALO_HAMP-MWR_cloud_mask_{date}_v{cloud_mask_version}.nc')

radar = xarray.open_dataset(f'{unified_data_dir}radar_{date}_v0.9.nc')

retrieval_file = glob.glob(f'{retrieval_data_dir}/EUREC4A_HALO_HAMP_lwpiwv_l2_any_v0.9_{date}[0-9][0-9][0-9][0-9][0-9][0-9].nc')[0]
...
fig.savefig(f'{path_plots}timeseries_{start}_v{cloud_mask_version}.png', dpi=250)
plt.close(fig)
